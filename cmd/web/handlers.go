...
import (
	...
	"snippetbox.abiral.net/internal/validator"
)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// Changes the sessionId. Apparently it's good practice to do so
...
func (app *application) accountPasswordUpdate(w http.ResponseWriter, r *http.Request) {
	...
	print("Hello")
	app.render(w, http.StatusOK, "passwordUpdate.tmpl.html", data)
}
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		data := app.newTemplateData(r)
		data.Form = form
		app.render(w, http.StatusUnprocessableEntity, "passwordUpdate.tmpl.html", data)
		return
	}
